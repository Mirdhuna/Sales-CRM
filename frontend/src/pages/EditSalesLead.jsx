...
import { getSalesLeadById, updateSalesLead, qualifySalesLead } from "../services/SalesLeads";

function EditSalesLead() {
    ...
    const fetchLead = async () => {
        try {
            const response = await getSalesLeadById(id);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await updateSalesLead(id, formData);
            console.log(formData);
            showAlert("success", "Lead Added", "Sales lead has been updated successfully.", () => {
                setAlertModal(null);
                navigate("/salesLeads");
            });
        } catch (err) {
            console.error(err);
            showAlert("error", "Failed", "Failed to update sales lead. Please try again.");
        }
    };

    /*handling disqualify btn*/
    const handleDisqualify = async () => {
        try {
            await updateSalesLead(id, {
                ...formData, status: "Disqualified"
            });
            setFormData(prev => ({
                ...prev, status: "Disqualified"
            }));

            showAlert("success", "Lead Disqualified", "The lead has been marked as Disqualified.", () => {
                setAlertModal(null);
                navigate("/salesLeads");
            });
            ...
            console.error(err);
            showAlert("error", "Failed", "Failed to disqualify the lead.");
        }
    };
    ...
    const handleQualify = async () => {
        try {
            await qualifySalesLead(id);

            showAlert(
                "success",
                "Lead Qualified",
                "The lead has been converted successfully.",
                () => {
                    setAlertModal(null);
            ...
            <div className="salesLead-container">
                ...
                <div className="salesLead-actions">
                    <div className="left-actions">
                        <button className="qualify-btn" onClick={handleQualify}>Qualify</button>
                        <button className="disqualify-btn" onClick={handleDisqualify}>Disqualify</button>
